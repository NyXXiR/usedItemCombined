...
////////////////////패널 하단
		...
		table.setBounds(300, 108, 995, 533);
		
		JTable page01 = new JPanel();
	       ItemDB itemDB2 = new ItemDB();
	       itemDB2.selectData("num");      
	       page01.setBounds(10, 10, 10, 10);      //원래 표     
	    
	    JPanel page02 = new JPanel();
		   itemDB2.selectData("price"); 
	       page02.setBounds(10, 10, 10, 10);      //저가순
	      
	      
	    JPanel page03 = new JPanel();
	      itemDB2.selectDataDesc("price"); 
	      page03.setBounds(10, 10, 10, 10);    //고가순
